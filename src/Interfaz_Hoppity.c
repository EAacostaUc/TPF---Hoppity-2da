...
int bandNombre1 = 0, bandNombre2 = 0;
//int turno=0;
...
void aprieta_pasar_turno () {
	...
	if (var1 == 1) {
		...
		juegaMaquinaIA (tablero, &fila_actualM, &colum_actualM, &fila_nuevaM, &colum_nuevaM, &FichaColor);
		solucionMov2fichas();
...
//	char *mensaje=malloc(5*sizeof(int));
//	*(mensaje + 0)= '(';
//	*(mensaje + 1)= atof(fila_actual1);
//	mensaje[2] = ',';
//	mensaje[3] = colum_nueva1 + '0';
//	mensaje[4] = ')';
//	mensaje[5] = '\0';
//
//	gchar *Mensaje = g_strdup_printf("%d", mensaje);
//
...
*/
void aprieta_juego_nuevo (GtkWidget *event_box, GdkEventButton *event, gpointer data) {
	...
	,var1 = 0, puerta = 0, puerta2 = 1, puerta3 = 1;
